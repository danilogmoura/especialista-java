...
import com.github.danilogmoura.agencia.CadastroPacoteViagem;
import com.github.danilogmoura.agencia.PacoteViagem;
...
//        System.out.println(pacoteEncontrado);
    ...
    private static void imprimirPacotes(List<PacoteViagem> pacotes) {
        for (PacoteViagem pacote : pacotes) {
            System.out.printf("Pacote: %s. Preço: %.2f%n", pacote.getDescricao(), pacote.getPrecoPorPessoa());
        }
    }
}
