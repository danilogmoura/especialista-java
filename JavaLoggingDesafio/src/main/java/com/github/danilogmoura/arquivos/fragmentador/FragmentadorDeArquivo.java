package com.github.danilogmoura.arquivos.fragmentador;
...
public class FragmentadorDeArquivo {
    ...
    public void fragmentar() throws IOException {
        logger.debug("Fragmentação invocada para arquivo original {} com fragmentos de até {} bytes", arquivo, tamanhoFragmento);
